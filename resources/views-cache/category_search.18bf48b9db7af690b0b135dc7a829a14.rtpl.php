            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Código</th></th>
                    ...
                    <?php $counter1=-1;  if( isset($category) && ( is_array($category) || $category instanceof Traversable ) && sizeof($category) ) foreach( $category as $key1 => $value1 ){ $counter1++; ?>
                      <tr>
                        ...
                        <td class="d-flex justify-content-end">
                            <a href="/categoria/update/<?php echo htmlspecialchars( $value1["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="px-2"><span class="badge badge-sm bg-gradient-info">Editar</span></a>          
                            <a data-bs-toggle="modal" href="#exampleModal" class="px-2" onclick="cahngeRouteDelete('<?php echo htmlspecialchars( $value1["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>')"><span class="badge badge-sm bg-gradient-danger">Excluir</span></a>
                        </td>
                      </tr>                  
                    <?php } ?>
                  </tbody>
