              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="d-flex justify-content-end">
                    ...
                    <button-delete route="/categoria/delete/<?php echo htmlspecialchars( $value1["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" id="<?php echo htmlspecialchars( $value1["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"></button-delete>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
