<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="container-fluid py-1">
  Página/Marca/<h7 class="font-weight-bolder mb-0" style="color: aliceblue;" id="titile">Cadastro</h7>
</div>
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="input-group input-group-static mb-4">
                    <label>Nome</label>
                    <input type="text" name="name" value="<?php echo htmlspecialchars( $brand["name"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="form-control">
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-sm-6 col-12 mt-sm-0 mt-2">
                    <a href="/marca"><button class="btn bg-gradient-info w-100 mb-0 toast-btn" type="button"
