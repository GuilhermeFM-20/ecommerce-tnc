...
<head>
  ...
  <link href="/resources/views/assets/css/select2.min.css" rel="stylesheet" />

  <link href="/resources/views/assets/css/style.css" rel="stylesheet" />
  <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
  <script src="/resources/views/assets/js/jquery-3.7.1.min.js"></script>
  ...
  <aside
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " id="Dashboard" href="/">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="/resources/views/assets/img/small-logos/logo-spotify.svg"
